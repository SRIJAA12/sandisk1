...
with row1_col1:
    ...
    st.markdown(
        ...
        <div style="margin-top:12px; text-align:center;">
            <a href="#" onclick="window.location.href = window.location.origin + '/?page=pages/01__Module_1.py'" style="text-decoration:none;">
...
with row1_col2:
    ...
    st.markdown(
        """
        <div style="margin-top:12px; text-align:center;">
            <a href="#" onclick="window.location.href = window.location.origin + '/?page=pages/02__Module_2.py'" style="text-decoration:none;">
...
with row2_col1:
    ...
    st.markdown(
        """
        <div style="margin-top:12px; text-align:center;">
            <a href="#" onclick="window.location.href = window.location.origin + '/?page=pages/02__Module_3.py'" style="text-decoration:none;">
...
with row2_col2:
    ...
    st.markdown(
        """
        <div style="margin-top:12px; text-align:center;">
            <a href="#" onclick="window.location.href = window.location.origin + '/?page=pages/04__Module_4.py'" style="text-decoration:none;">
