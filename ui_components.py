...
def show_enhanced_video_comparison(input_path, output_path, original_size_mb, optimized_size_mb, total_frames, saved_frames):
    ...
    st.markdown("---")
    st.markdown("### 🎬 Enhanced Video Comparison & Mathematical Analysis")
    ...
    with col2:
        ...
        <div class="comparison-arrow">
            ...
            <div class="arrow-label">AURA AI</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with form_col1:
        st.markdown("#### ✏️ Formula 1: Write Reduction %")
    ...
    with form_col2:
        st.markdown("#### ⏱️ Formula 2: Lifespan Extension")
        st.markdown("**General Formula:**")
        st.latex(r'''
